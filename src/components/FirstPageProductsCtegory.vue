    ...
    <div class="category">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div id="img-pill-1" class="tab-pane fade in active">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                        <img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood">
                                    </div>
                                </div>
                        ...
                        <ul class="nav nav-pills col-lg-6 col-md-6 col-sm-6 col-xs-12 img-pill">
                            <li class="active col-lg-4 col-md-4 col-sm-4 col-xs-12"><a data-toggle="pill" href="#img-pill-1"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></li>
                            <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a data-toggle="pill" href="#img-pill-2"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></li>
                            <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a data-toggle="pill" href="#img-pill-3"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></li>
                            <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a data-toggle="pill" href="#img-pill-4"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs menu-category">
                <li class="new-menu active"><a data-toggle="tab" href="#menu-tab-new" id="new-menu">New Arrivals</a><figure id="new-2" class="hidden-xs"></figure></li>
                <li class="shop-menu"><a data-toggle="tab" href="#menu-tab-shop">Shop</a><figure id="shop-2" class="hidden-xs"></figure></li>
                <li class="wedding-menu"><a data-toggle="tab" href="#menu-tab-wedding">Wedding</a><figure id="wedding-2" class="hidden-xs"></figure></li>
                <li class="holiday-menu"><a data-toggle="tab" href="#menu-tab-holiday">Holiday</a><figure id="holiday-2" class="hidden-xs"></figure></li>
                <li class="other-menu"><a data-toggle="tab" href="#menu-tab-other">Other</a><figure id="other-2" class="hidden-xs"></figure></li>
            </ul>
            <div class="row">
                    ...
                    <div id="menu-tab-new" class="tab-pane fade in active">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
                            <div class="product-image-category">
                                <figure class="sale"><a href="#"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></figure>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
                            <div class="product-image-category">
                                <a href="#"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a>
                                <div class="product-icon-category">
                                    <a href="#" data-toggle="modal" data-target="#myModal"><i class="far fa-eye"></i></a>
                                    <a href="#"><i class="fas fa-shopping-basket"></i></a>
                                    <a href="#"><i class="far fa-heart"></i></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 product-category">
                            <div class="product-image-category">
                                <figure class="hot"><a href="#"><img src="../assets/img/340x420.png" class="img-responsive" alt="holiwood"></a></figure>
                                <div class="product-icon-category">
                                    <a href="#" data-toggle="modal" data-target="#myModal"><i class="far fa-eye"></i></a>
                                    <a href="#"><i class="fas fa-shopping-basket"></i></a>
                                    <a href="#"><i class="far fa-heart"></i></a>
